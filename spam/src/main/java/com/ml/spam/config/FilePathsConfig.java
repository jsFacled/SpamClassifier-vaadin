...
public class FilePathsConfig {
    ...
    public static final String CATEGORIZED_WORDS_BASE_JSON_PATH = "static/dictionary/new_categorized_words_base_only.json";
    ...
    public static final String LEXEMES_REPOSITORY_JSON_PATH = "static/dictionary/structured_lexemes_repository.json";
