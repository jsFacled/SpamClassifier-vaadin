...
public class FilePathsConfig {
  ...
  //  public static final String CATEGORIZED_WORDS_BASE_JSON_PATH = "static/dictionary/base/categorized_words_base_only.json";
    ...
    public static final String TEST_MESSAGES_CSV_ESPAÑOL_DATA_PATH = "static/datasets/originales/test-mensajesEspañol.csv";
    public static final String TRAIN_MESSAGES_CSV_ESPAÑOL_DATA_PATH = "static/datasets/train-mensajesEspañol.csv";
    public static final String CORREOS_SPAM_FAC_TXT_PATH = "static/datasets/originales/correos-spam-fac.txt";
    public static final String CLEANED_TRAIN_MESSAGES_CSV_PATH = "static/datasets/originales/train-mensajesEspañol_cleaned.csv";
